...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.order_by:
                if (!tasks.isEmpty()) {
                    switch (tasksListFragment.getCurrentLayout()){
                        case TasksListFragment.LIST_LAYOUT:
                                tasksListFragment.changeListLayout(TasksListFragment.GRID_LAYOUT);
                                break;

                        case TasksListFragment.GRID_LAYOUT:
                            tasksListFragment.changeListLayout(TasksListFragment.STAGGERED_GRID_LAYOUT);
                            break;

                        case TasksListFragment.STAGGERED_GRID_LAYOUT:
                            tasksListFragment.changeListLayout(TasksListFragment.LIST_LAYOUT);
                            break;
                    }
                } else {
