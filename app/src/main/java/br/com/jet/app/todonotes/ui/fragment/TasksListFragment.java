...
public class TasksListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tasksList.setLayoutManager(getLayoutManagerFromPreferences());
    ...
    public void changeListLayout(int layoutIndex) {
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("layout_preference_5", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putInt("layout_index_5", layoutIndex);
        editor.apply();

        tasksList.setLayoutManager(getLayoutManagerFromPreferences());
    }

    public RecyclerView.LayoutManager getLayoutManagerFromPreferences() {
        SharedPreferences sharedPreferences = getActivity().getSharedPreferences("layout_preference_5", Context.MODE_PRIVATE);
        int layoutIndex = sharedPreferences.getInt("layout_index_5", 0);
        Log.d(TAG, "getLayoutManagerFromPreferences: " + layoutIndex);
        return layoutManager[layoutIndex];
    }
